...
ActiveRecord::Schema.define(version: 2021_05_28_084141) do
  ...
  create_table "delivery_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_info_id"], name: "index_delivery_addresses_on_purchase_info_id"
  end
  ...
  add_foreign_key "delivery_addresses", "purchase_infos"
